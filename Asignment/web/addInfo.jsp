        ...
        <div class="container h-100">
            <div class="row d-flex justify-content-around align-items-center h-100">
                <div class="col-xl-9 col-lg-8 col-xl-5 offset-xl-1">       
                    <form method="POST" action="addInfo" enctype="multipart/form-data" style="margin-top: 30px" id="form">
                        <div class="card" style="border-radius: 15px;">
                            <h1 class="mb-4" style="text-align: center; margin-top: 20px">THEM MOI THONG TIN TUYEN SINH</h1>
                            <div class="card-body">
                                ...
                                <div class="row align-items-center pt-4 pb-3">
                                    ...
                                    <div class="col-md-9 pe-5">
                                        <input type="text" name="title" id="form3Example4" class="form-control form-control-lg" value="" required>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center py-3" style="display: flex;justify-content: end"> 
                                    <div class="col-md-3 ps-5">
                                        <button type="submit"  value="0"class="btn btn-primary btn-lg" style=" color: white; background: red">Post</button>
                                    </div>
                                </div>
