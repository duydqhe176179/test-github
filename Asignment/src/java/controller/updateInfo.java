...
public class updateInfo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        Info i = dao.getInfoById(Integer.parseInt(request.getParameter("id_info")));
...
// Save the uploaded image with the desired file name to the directory
            ...
            fileName = info.getImage();
        }
        String title = request.getParameter("title");
        String content = request.getParameter("content");
        int id_info = info.getId();
        dao.updateInfo(id_info, fileName, title, content);
