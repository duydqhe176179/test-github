 ...
 */
@MultipartConfig
public class addOldStudent extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("addOldStudent.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        oldStudent o = new oldStudent(fileUrl, review, name);
        if (dao.addoldStudent(o)) {
            System.out.println("add dc r");
        } else {
