 ...
 */
@MultipartConfig
public class updateOldStudent extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        oldStudent o = dao.getOldById(Integer.parseInt(request.getParameter("id_old")));

        request.setAttribute("o", o);

        request.getRequestDispatcher("updateOldStudent.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        oldStudent old=dao.getOldById(id);
        String fileName = "";
...
// Save the uploaded image with the desired file name to the directory
        ...
        int id_old = old.getId();
        dao.updateOld(id_old, fileName, review, name);
        response.sendRedirect("displayRegister");
    }
