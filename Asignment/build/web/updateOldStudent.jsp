        ...
        <div class="container h-100">
            <div class="row d-flex justify-content-around align-items-center h-100">
                <div class="col-xl-9 col-lg-8 col-xl-5 offset-xl-1">       
                    <form method="POST" action="updateOldStudent" enctype="multipart/form-data" style="margin-top: 30px" id="form">
                        <div class="card" style="border-radius: 15px;">
                            <h1 class="mb-4" style="text-align: center; margin-top: 20px">CHINH SUA THONG TIN CUU SINH VIEN</h1>
                            <div class="card-body">
                                ...
                                <div class="row align-items-center pt-4 pb-3">
                                    ...
                                    <div class="col-md-9 pe-5">
                                        <input type="text" name="review" id="form3Example4" class="form-control form-control-lg" value="${o.review}" required>
                                    </div>
                                </div>
                                <div class="row align-items-center pt-4 pb-3">
                                    <div class="col-md-3 ps-5">
                                    ...
                                    <div class="col-md-9 pe-5">
                                        <input type="text" name="name" id="form3Example4" class="form-control form-control-lg" value="${o.name}" required>
                                    </div>
                                </div>
